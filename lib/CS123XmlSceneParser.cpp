...
bool CS123XmlSceneParser::parsePrimitive(const QDomElement &prim, CS123SceneNode* node) {
    ...
    else if (primType == "spike") primitive->type = PrimitiveType::PRIMITIVE_SPIKE;
    else if (primType == "tank") primitive->type = PrimitiveType::PRIMITIVE_TANK;
    else if (primType == "terrain") primitive->type = PrimitiveType::PRIMITIVE_TERRAIN;
